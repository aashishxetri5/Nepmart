...
public class ProductActivities extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("addCategory") != null) {
            ...
            /* Codes to add category */
            String catTitle = request.getParameter("categoryTitle");
            String catDesc = request.getParameter("categoryDetail");

            Category category = new Category(0, catTitle, catDesc);
