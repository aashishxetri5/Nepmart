<%@page import="com.org.nepmart.daoImpl.OrderDaoImpl"%>
<%@page import="com.org.nepmart.entities.Orders"%>
<%@page import="java.util.ArrayList"%>

<%

    ArrayList<Orders> allOrders = new OrderDaoImpl().getAllOrders();
    int count = 1;
%>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="delete?deleteId<%//=user.getId()%>" 
